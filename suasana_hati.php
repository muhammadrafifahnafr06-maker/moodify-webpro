<?php
session_start();
include 'Config.php'; // Pastikan nama file 'Config.php' atau 'config.php' sesuai dengan nama file aslimu
...
// Ambil username dengan aman, jika tidak ada set ke default 'User'
$username = $row['username'] ?? 'User';

// Pastikan nama tabel di database kamu adalah 'suasana_hati' (sesuai gambar phpMyAdmin kamu)
...
.gembira{ background:#FCE8D5; }
.tenang{ background:#DDF6EA; }
.sedih{ background:#E7E5FA; }
.lelah{ background:#F4E0D8; }
.marah{ background:#F8E3E5; }
.semangat{ background:#F9F1BE; }
...
<div class="container">
    <div class="card">
        ...
        <div class="subtitle">Apa yang kamu rasakan hari ini?</div>
    ...
    <div class="card">
        <h2 style="color:#f4d600;">Riwayat Mood</h2>
        <table>
            <tr>
                <th>No</th>
                <th>Mood</th>
            ...
            <tr>
                ...
                <td>
                    <a class="edit" href="edit_mood.php?id=<?php echo $d['id_mood']; ?>">Edit</a>
                    |
                    <a class="hapus" href="hapus_mood.php?id=<?php echo $d['id_mood']; ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </table>
